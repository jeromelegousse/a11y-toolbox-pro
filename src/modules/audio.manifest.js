  ...
  guides: [
    {
      ...
      description:
        'Vérifiez le rendu des alertes critiques et assurez-vous que les utilisateurs peuvent ajuster le volume.',
      category: 'interaction',
      prerequisites: [
      ...
      steps: [
        {
          ...
          mode: 'manual',
          detail:
            'Ouvrez Options & Profils → Alertes sonores et ajustez le volume entre 40 % et 60 % dans un environnement calme.',
        },
        {
          ...
          mode: 'manual',
          detail:
            'Déclenchez un événement « Critique » et vérifiez que l’alerte est audible et non intrusive.',
        },
      ],
      assistance: {
        microcopy:
          'Conservez une marge de 20 dB entre les alertes critiques et les notifications informatives.',
        resources: [
          {
    ...
    fields: [
      {
        ...
        onChange: (value) => {
          window.a11ytb?.logActivity?.(`Volume audio réglé à ${Math.round(value * 100)} %`, {
            tone: 'info',
            tags: ['audio'],
          });
        },
        ...
        return [
          {
            ...
            onChange: (enabled) => {
              ...
              window.a11ytb?.logActivity?.(`${label} ${status}`, {
                tone: enabled ? 'confirm' : 'toggle',
          ...
          },
          {
            ...
            onChange: (value) => {
              ...
              window.a11ytb?.logActivity?.(
                `Son ${label.toLowerCase()} réglé sur ${selectedLabel}`,
                { tone: 'info', tags: ['audio', 'preferences'] }
              );
            },
          },
        ];
