...
const TRANSLATIONS = {
  fr: {
    ...
    toolbar: {
      ...
      dockBottom: 'Dock bas',
      dockCurrent: 'Actuel : {position}',
      dockAnnouncement: 'Position du dock : {position}.',
      fullscreenEnter: 'Plein écran',
      fullscreenExit: 'Quitter le plein écran',
      fullscreenEnterTitle: 'Afficher la boîte à outils en plein écran',
      fullscreenExitTitle: 'Quitter le plein écran et revenir à la fenêtre flottante',
      reset: 'Réinitialiser',
      close: 'Fermer',
    },
    language: {
  ...
  en: {
    ...
    toolbar: {
      ...
      dockCurrent: 'Current: {position}',
      dockAnnouncement: 'Dock position: {position}.',
      fullscreenEnter: 'Enter fullscreen',
      fullscreenExit: 'Exit fullscreen',
      fullscreenEnterTitle: 'Open the toolbox in fullscreen',
      fullscreenExitTitle: 'Exit fullscreen and return to the floating panel',
      reset: 'Reset',
      close: 'Close',
    },
    language: {
